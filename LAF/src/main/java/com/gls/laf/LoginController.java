...
import com.gls.laf.user.UserServiceImpl;
import com.gls.laf.user.UserVO;
import com.gls.laf.user.model.GoogleOAuthRequest;
import com.gls.laf.user.model.GoogleOAuthResponse;
...
//		model.addAttribute("google_url", url);
	...
	// 구글 Callback호출 메소드
		...
		public String googleAuth(Model model, @RequestParam(value = "code") String authCode, HttpServletRequest request,
			...
			googleOAuthRequestParam.setClientId("1091952631277-n44a5kuq13om818ukiqur5o0q9jrluko.apps.googleusercontent.com");
			googleOAuthRequestParam.setClientSecret("v8Ds68H-71sYXbZ_YIp34aCz");
			googleOAuthRequestParam.setCode(authCode);
			googleOAuthRequestParam.setRedirectUri("http://localhost:8080/laf/login/oauth2callback");
